...
pub fn register_handles() -> impl Fn(Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        environment_fingerprint_command::environment_fingerprint_modify_ua,
        environment_fingerprint_command::environment_fingerprint_modify_by_colname,
        ...
        environment_command::environment_modify_default_url,
        environment_command::environment_advanced_modify,
