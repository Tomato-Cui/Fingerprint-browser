...
pub async fn query_by_id(
    ...
    match lp_services::environment_fingerprint::query_by_id(&state.user_uuid, payload.id).await {
        Ok(data) => {
...
pub async fn query(
    ...
    match lp_services::environment_fingerprint::query(
        &state.user_uuid,
        payload.page_num,
        payload.page_size,
    )
...
pub async fn create(
    ...
    match lp_services::environment_fingerprint::create(&state.user_uuid, &payload).await {
...
pub async fn modify(
    ...
    match lp_services::environment_fingerprint::modify(
        &state.user_uuid,
...
pub async fn delete(
    ...
    match lp_services::environment_fingerprint::delete(&state.user_uuid, payload.id).await {
