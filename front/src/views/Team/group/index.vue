    ...
    <div class="group-content">
        ...
        <el-main class="group-main">
            <el-table :data="groups" stripe border class="group-table">
                ...
                <el-table-column prop="member_count" label="包含账号" align="center" class="font-color"></el-table-column>
            ...
            <div>
                <el-form :model="form" label-width="180px">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <el-cascader-panel style="width: fit-content" :props="props" :options="options"
                            v-model="form.role" />
                    </div>
                    <!-- </el-form-item> -->
                </el-form>
        ...
        <el-dialog title="添加成员" v-model="memberDialogVisible" width="1000" :close-on-click-modal="false"
            ...
            <el-form :model="memberForm" :rules="rules" ref="formRef" label-width="100px">
                ...
                <el-form-item label="授权环境">
                    ...
                    <div v-if="memberForm.selectedEnvironment.length === 0" class="error-text">
                        请选择需要授权给该员工管理的环境
                    </div>
                </el-form-item>
            </el-form>
            ...
            <div class="dialog-content">
                ...
                <main class="main-content">
                    ...
                    <div class="filters">
                        ...
                        <el-select v-model="selectedEnvironmentType" placeholder="所有环境" size="large"
                            class="filter-item">
                            <el-option v-for="item in environmentType" :key="item.id" :label="item.value"
                                :value="item.id" />
                        </el-select>
                        <el-select v-model="selectedOperationType" placeholder="所有操作类型" size="large"
                            class="filter-item">
                            <el-option v-for="item in operationType" :key="item.id" :label="item.value"
                                :value="item.id" />
                        </el-select>
                    ...
                    <!-- Environment List -->
                    <el-table :data="filteredEnvironments" border style="width: 100%;"
                        @selection-change="handleSelectionChange" v-model:selection="selectedRowsEnv"
                        ref="multipleTable">
...
const groups = ref([
    { id: 1, name: "员工", accounts: 1, remark: "无", role: [10101] },
...
const createGroup = () => {
    ...
    teamApi.createGroupApi(form.value)
...
const deleteGroup = (group: any) => {
    ...
    // })
    // teamApi.deleteGroupApi(group.id);
};
...
const handleConfirm = () => {
    ...
    // console.log("form.value:", form.value.groupName);
    //调用创建分组api
    teamApi.createGroupApi(form.value);
