  ...
  <Layout>
    ...
    <div class="browser-header">
      <el-affix :offset="85">
        ...
        >
          <el-menu-item @click="scrollToSection('base-info')"
            >基础信息</el-menu-item
          >
          <el-menu-item @click="scrollToSection('proxy-info')"
            >代理信息</el-menu-item
          >
          <el-menu-item @click="scrollToSection('account-info')"
            >账号平台</el-menu-item
          >
          <el-menu-item @click="scrollToSection('fingerprint-info')"
            >指纹配置</el-menu-item
          >
          <el-menu-item @click="scrollToSection('advanced-settings')"
            >高级设置</el-menu-item
          >
        </el-menu>
      </el-affix>
          ...
          <el-row>
            ...
            <el-col :span="6" :offset="8">
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-button type="primary" @click="checkNetwork"
                    >检查网络</el-button
                  >
                </el-col>
              </el-row>
