        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            <div class="space-y-2">
              ...
              <Input id="login-username" class="w-full" v-model="loginForm.username" placeholder="请输入账号" />
            </div>
            <div class="space-y-2">
              <Label for="login-password">密码</Label>
              <Input id="login-password" @keyup.enter="handleLogin" class="w-full" v-model="loginForm.password"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
                ...
                <label for="remember-me"
                  class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">记住我</label>
              </div>
            ...
            <div class="w-full space-y-4">
              <div class="relative">
                ...
                <div class="relative flex justify-center text-xs uppercase">
                  <span class="bg-background px-2 text-muted-foreground">其他登录方式</span>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            <div class="space-y-2">
              ...
              <Input id="register-username" class="w-full" v-model="registerForm.username" placeholder="请输入账号" />
            </div>
            <div class="space-y-2">
              <Label for="register-password">密码</Label>
              <Input id="register-password" class="w-full" v-model="registerForm.password" type="password"
                placeholder="请输入密码" />
            </div>
            <div class="space-y-2">
              <Label for="register-email">邮箱</Label>
              <Input id="register-email" class="w-full" v-model="registerForm.email" placeholder="请输入邮箱" />
            </div>
            <div class="flex items-center space-x-2">
            ...
            <Button class="w-full cursor-pointer" :disabled="loading" @click="handleRegister">
              {{ loading ? '注册中...' : '注册' }}
            </Button>
          </CardContent>
        </Card>
...
import { LucideGithub, LucideMessageCircle, LucideSmartphone } from 'lucide-vue-next'
...
const handleRegister = () => {
  ...
  register(registerForm.value.email, registerForm.value.username, registerForm.value.password).then((res) => {
    loading.value = false
