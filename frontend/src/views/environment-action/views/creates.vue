...
<template>
        ...
        <div class="flex items-center gap-2 border rounded-md">
            <NumberField>
                <NumberFieldContent>
                    ...
                    <NumberFieldInput class="focus-visible:ring-blue-400 hover:border-blue-500" />
                    <NumberFieldIncrement class="text-gray-500" />
                </NumberFieldContent>
            </NumberField>
        </div>
    </div>
    <Accordion type="single" class="w-full px-6 py-3" collapsible default-value="basic-setting">
    ...
    <Accordion type="single" class="w-full px-6 py-3" collapsible default-value="proxy-setting">
        <AccordionItem class="border-0" value="proxy-setting">
            <AccordionTrigger class="hover:no-underline rounded-md text-sm p-3 bg-gray-50 mb-2">代理信息</AccordionTrigger>
            <AccordionContent class="px-4 space-y-4">
                <Tabs default-value="custom" class="">
                    ...
                    <TabsContent value="custom">
                        <div class="space-y-2 flex items-center">
                            <p class="w-36 flex justify-end items-center text-sm font-medium text-gray-700 pr-8">代理类型
                            </p>
                            <div class="w-full flex gap-x-4">
                                <Select>
                                    <SelectTrigger class="w-1/3">
                                        <SelectValue placeholder="No Proxy (本地直连)"
                        ...
                        <div class="space-y-2 flex items-center">
                            <p class="w-36 flex justify-end items-center text-sm font-medium text-gray-700 pr-8">IP查询渠道
                            </p>
                            <div class="w-full">
                                <div class="flex gap-4 ">
                                    <Select>
    ...
    <!-- Account Platform -->
    <Accordion type="single" class="w-full px-6 py-3" collapsible default-value="account-setting">
        <AccordionItem value="account-setting" class="border-0">
            ...
            <AccordionContent class="px-4 space-y-4">
                <div class="space-y-2 flex items-center">
                    <p class="w-36 flex justify-end items-center text-sm font-medium text-gray-700 pr-8">账号平台</p>
                    <div class="w-full flex gap-x-4">
                        <Select>
                            <SelectTrigger class="w-full">
                ...
                <div class="space-y-2 flex items-center">
                    <p class="w-36 flex justify-end items-center text-sm font-medium text-gray-700 pr-8">标签页</p>
                    <div class="w-full  flex gap-x-4">
    ...
    <!-- Advanced Settings -->
    <Accordion type="single" class="w-full px-6 py-3" collapsible default-value="software-setting">
        <AccordionItem value="software-setting" class="border-0">
            ...
            <AccordionContent class="px-4 space-y-4">
                <Alignment title="应用">
                    <button class="px-4 py-1.5 rounded-md text-sm bg-blue-50 text-blue-600">跟随团队</button>
                    <button class="px-4 py-1.5 rounded-md text-sm text-gray-600">取消跟随</button>
                </Alignment>
