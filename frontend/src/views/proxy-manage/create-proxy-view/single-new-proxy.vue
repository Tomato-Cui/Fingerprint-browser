...
<template>
  <Layout class="h-full border border-red-500">
    <!-- Form -->
    <div
      @submit.prevent="handleSubmit"
      class="flex flex-col justify-start pt-3 space-y-6 w-full h-full border border-blue-500"
    >
      <!-- Proxy Type -->
      ...
      <div class="flex gap-4 items-start border w-[500px]">
      ...
      <div
        ...
        class="flex flex-row mt-4 space-y-4 border w-[500px]"
      >
        <div class="flex flex-row">
          <div class="flex">
            <label class="text-sm text-gray-500 border">发生IP变化时</label>
          </div>
      ...
      <!-- Form Actions -->
      <div
        class="flex gap-x-4 justify-end items-center border border-green-500"
      >
        <button
          type="button"
