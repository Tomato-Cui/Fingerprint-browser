...
const allColumns = ref([
  { key: "id", label: "代理序号", visible: true },
  { key: "name", label: "代理名称", visible: true },
  { key: "proxy_belong", label: "代理归属", visible: true },
  { key: "action", label: "操作", visible: true },
  { key: "proxy_status", label: "代理状态", visible: true },
  { key: "ip_query_channel", label: "IP查询渠道", visible: true },
  { key: "group_name", label: "分组", visible: true },
  { key: "browser_environment", label: "浏览器环境", visible: true },
  { key: "cloud_phone_environment", label: "云手机环境", visible: true },
  { key: "create_at", label: "创建信息", visible: true },
]);
