...
import { environment_proxy_group_create } from "@/commands/environment-proxy-group";
...
//确认
const subMit = () => {
  console.log("payload", payload.name, payload.description);

  environment_proxy_group_create(payload).then((res) => {
    console.log("res", res);
    toast.success("创建成功");
  });
