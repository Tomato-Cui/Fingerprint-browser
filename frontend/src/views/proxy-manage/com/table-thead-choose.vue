...
const allColumns = ref([
  ...
  { key: "attribution", label: "代理归属", visible: true },
  { key: "action", label: "操作", visible: true },
  { key: "state", label: "代理状态", visible: true },
  { key: "channel", label: "IP查询渠道", visible: true },
  { key: "group", label: "分组", visible: true },
  { key: "browser_environment", label: "浏览器环境", visible: true },
  { key: "phone_environment", label: "云手机环境", visible: true },
  { key: "create_message", label: "创建信息", visible: true },
]);
const saveChoose = () => {
  copyColumns.value = JSON.parse(JSON.stringify(allColumns.value));
  emit("select", allColumns.value);
