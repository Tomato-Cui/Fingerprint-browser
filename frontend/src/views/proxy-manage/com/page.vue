...
const nextPage = () => {
  console.log("下一页", isLastPage.value);
...
<template>
  <div class="flex justify-end items-center space-x-4 h-12 text-sm border-t">
    <!-- Total count -->
    ...
    <div class="flex items-center space-x-2">
      <button
        ...
        class="flex justify-center items-center w-8 h-8 text-gray-400 rounded-lg hover:bg-gray-100 disabled:opacity-50"
      >
        <AltArrowDownIcon class="w-4 h-4 rotate-90" />
      </button>

      <div
        class="flex h-8 min-w-[32px] items-center justify-center rounded-lg bg-gray-100 px-3"
      >
        {{ currentPage }}
      </div>
      ...
      <More class="w-full">
        <MoreTrigger @click="" class="w-full">
          ...
          >
            ...
            <AltArrowDownIcon class="w-4 h-4 transition-transform rotate-180" />
          </button>
        </MoreTrigger>
