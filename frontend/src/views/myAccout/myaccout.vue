        ...
        <table class="w-full min-w-max">
          <thead class="sticky top-0 z-10 bg-gray-50">
            <tr>
              ...
              <th
                class="p-4 w-32 text-sm font-medium text-center text-gray-600"
              >
                所属平台
              </th>
              <th
                ...
                <div class="flex gap-4 justify-center items-center">
                  ...
                  <More>
                    ...
                    <MoreContent>
                      ...
                      >
                        <Settings2Icon class="w-4 h-4" />查看详情
                      </MoreItem>
                      <MoreItem
                        class="cursor-pointer"
                        @click="deleteOpenHandle(item)"
                      >
...
for (let i = 0; i < 130; i++) {
  const newAgentsData = {
    ...
    selected: false,
    platform: "谷歌" + i,
    icon: "src/assets/images/guge.svg?height=20&width=20",
    environment: "新建浏览器1",
    createdAt: "2024.11.23 14:30:00",
    addedBy: "本人",
  };
