    ...
    <div class="flex flex-col flex-1 px-4 w-full h-full rounded-xl select-none">
        ...
        <GroupChoose class="flex flex-col flex-1 select-none" :data="groupList">
            ...
            <div class="mb-4 flex items-center space-x-2 h-[60px]">
                ...
                <div class="w-[100px] h-[40px] bg-[#7744ff] flex rounded-lg items-center relative" :class="{
                ...
                <div class="flex overflow-x-auto flex-1 space-x-2 select-none scrollbar-hide cursor-grab"
                    ...
                    <More class="flex min-w-fit" v-for="action in visibleActions" :key="action.key">
                        ...
                        <MoreContent class="w-[140px]" v-if="action.children && selectedItems.length > 0">
                            <MoreItem v-for="item in action.children" @click="
            ...
            <div class="flex overflow-auto flex-col flex-1 rounded-lg">
                        ...
                        <tr v-for="(item, index) in filterData" :key="index" class="border-b"
                            ...
                            <template v-for="(value, key) in item as Record<string, any>" :key="key">
                                <td class="px-2 py-3 text-sm" v-if="key != 'uuid' && key != 'id'">
                                    ...
                                    <div v-else-if="key === 'status'" class="flex gap-x-2 items-center">
                                        <div class="rounded-full size-1.5" :class="{
                ...
                <div v-show="filterData.length == 0" class="flex flex-col flex-1 justify-center items-center space-y-3">
